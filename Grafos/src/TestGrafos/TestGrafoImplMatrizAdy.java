...
public class TestGrafoImplMatrizAdy {
    ...
    @Before
    public void setUp() {
        grafo = new GrafoImplMatrizAdy<>(10);
    }

    @Test
    public void testAgregarYeliminarVertice() {
        int tamAntes = grafo.listaDeVertices().tamanio();
        VerticeImplMatrizAdy<Integer> vert1 = new VerticeImplMatrizAdy<>(1);
        VerticeImplMatrizAdy<Integer> vert2 = new VerticeImplMatrizAdy<>(2);
        VerticeImplMatrizAdy<Integer> vert3 = new VerticeImplMatrizAdy<>(3);
    ...
    public void testVetice() {
        ...
        VerticeImplMatrizAdy<Integer> vert2 = new VerticeImplMatrizAdy<>(1);
        grafo.agregarVertice(vert2);
