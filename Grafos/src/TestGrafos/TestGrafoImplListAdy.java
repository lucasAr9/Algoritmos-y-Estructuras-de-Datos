...
public class TestGrafoImplListAdy {
    ...
    @Before
    public void setUp() {
        grafo = new GrafoImplListAdy<>();
    }

    @Test
    public void testAgregarYeliminarVertice() {
        int tamAntes = grafo.listaDeVertices().tamanio();
        VerticeImplListAdy<Integer> vert1 = new VerticeImplListAdy<>(1);
        VerticeImplListAdy<Integer> vert2 = new VerticeImplListAdy<>(2);
        VerticeImplListAdy<Integer> vert3 = new VerticeImplListAdy<>(3);
    ...
    public void testVetice() {
        ...
        VerticeImplListAdy<Integer> vert2 = new VerticeImplListAdy<>(1);
        grafo.agregarVertice(vert2);
